...
resourcename="dinoplaygroupsystem"  # lower case, only
resourcegroup="dinoplaygroupsystem_rg"
...
# git clone https://github.com/apilogicserver/dinoplaygroupsystem.git
# cd dinoplaygroupsystem
...
az group create --name dinoplaygroupsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dinoplaygroupsystem_rg --sku S1 --is-linux
az container create --resource-group dinoplaygroupsystem_rg --name dinoplaygroupsystem --image apilogicserver/dinoplaygroupsystem:latest --dns-name-label dinoplaygroupsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dinoplaygroupsystem.westus.azurecontainer.io:5656'
