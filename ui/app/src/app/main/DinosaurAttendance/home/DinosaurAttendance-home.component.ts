...
@Component({
  selector: 'DinosaurAttendance-home',
  templateUrl: './DinosaurAttendance-home.component.html',
  styleUrls: ['./DinosaurAttendance-home.component.scss']
})
export class DinosaurAttendanceHomeComponent implements AfterViewInit {
