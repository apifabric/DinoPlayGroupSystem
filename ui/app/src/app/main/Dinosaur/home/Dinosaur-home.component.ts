...
@Component({
  selector: 'Dinosaur-home',
  templateUrl: './Dinosaur-home.component.html',
  styleUrls: ['./Dinosaur-home.component.scss']
})
export class DinosaurHomeComponent implements AfterViewInit {
