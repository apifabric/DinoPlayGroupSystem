...
@Component({
  selector: 'PlayGroupHost-home',
  templateUrl: './PlayGroupHost-home.component.html',
  styleUrls: ['./PlayGroupHost-home.component.scss']
})
export class PlayGroupHostHomeComponent implements AfterViewInit {
