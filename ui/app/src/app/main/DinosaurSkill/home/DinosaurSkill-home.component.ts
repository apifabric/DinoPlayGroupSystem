...
@Component({
  selector: 'DinosaurSkill-home',
  templateUrl: './DinosaurSkill-home.component.html',
  styleUrls: ['./DinosaurSkill-home.component.scss']
})
export class DinosaurSkillHomeComponent implements AfterViewInit {
