...
@Component({
  selector: 'DinosaurActivity-home',
  templateUrl: './DinosaurActivity-home.component.html',
  styleUrls: ['./DinosaurActivity-home.component.scss']
})
export class DinosaurActivityHomeComponent implements AfterViewInit {
