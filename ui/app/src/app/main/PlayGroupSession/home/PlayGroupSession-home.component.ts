...
@Component({
  selector: 'PlayGroupSession-home',
  templateUrl: './PlayGroupSession-home.component.html',
  styleUrls: ['./PlayGroupSession-home.component.scss']
})
export class PlayGroupSessionHomeComponent implements AfterViewInit {
