...
@Component({
  selector: 'PlayGroupFacility-home',
  templateUrl: './PlayGroupFacility-home.component.html',
  styleUrls: ['./PlayGroupFacility-home.component.scss']
})
export class PlayGroupFacilityHomeComponent implements AfterViewInit {
