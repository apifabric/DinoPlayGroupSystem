...
@Component({
  selector: 'FeedLog-home',
  templateUrl: './FeedLog-home.component.html',
  styleUrls: ['./FeedLog-home.component.scss']
})
export class FeedLogHomeComponent implements AfterViewInit {
