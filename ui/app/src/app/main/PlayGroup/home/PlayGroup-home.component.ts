...
@Component({
  selector: 'PlayGroup-home',
  templateUrl: './PlayGroup-home.component.html',
  styleUrls: ['./PlayGroup-home.component.scss']
})
export class PlayGroupHomeComponent implements AfterViewInit {
