...
@Component({
  selector: 'DinosaurMeasurement-home',
  templateUrl: './DinosaurMeasurement-home.component.html',
  styleUrls: ['./DinosaurMeasurement-home.component.scss']
})
export class DinosaurMeasurementHomeComponent implements AfterViewInit {
